...
class ICNetModelFactory(object):
    ...
    @staticmethod
    def build(img_size, n_classes, weights_path=None, train=False):
        ...
        out_a = Conv2D(128, 1, name='conv2_1_1x1_proj')(out_b)
        out_a = BatchNormalization(name='conv2_1_1x1_proj_bn')(out_a)
        out_b = Conv2D(32, 1, activation='relu',
        ...
        out_b = Conv2D(32, 3, activation='relu', name='conv2_1_3x3')(out_b)
        out_b = BatchNormalization(name='conv2_1_3x3_bn')(out_b)
        out_b = Conv2D(128, 1, name='conv2_1_1x1_increase')(out_b)
        ...
        out_a = Conv2D(32, 1, activation='relu',
        ...
        out_a = Conv2D(32, 3, activation='relu', name='conv2_2_3x3')(out_a)
        out_a = BatchNormalization(name='conv2_2_3x3_bn')(out_a)
        out_a = Conv2D(128, 1, name='conv2_2_1x1_increase')(out_a)
        ...
        out_a = Conv2D(32, 3, activation='relu', name='conv2_3_3x3')(out_a)
        out_a = BatchNormalization(name='conv2_3_3x3_bn')(out_a)
        out_a = Conv2D(128, 1, name='conv2_3_1x1_increase')(out_a)
        ...
        out_a = Conv2D(256, 1, strides=2, name='conv3_1_1x1_proj')(out_b)
        out_a = BatchNormalization(name='conv3_1_1x1_proj_bn')(out_a)
        out_b = Conv2D(64, 1, strides=2, activation='relu',
        ...
        out_b = Conv2D(64, 3, activation='relu', name='conv3_1_3x3')(out_b)
        out_b = BatchNormalization(name='conv3_1_3x3_bn')(out_b)
        out_b = Conv2D(256, 1, name='conv3_1_1x1_increase')(out_b)
        ...
        out_a = Conv2D(64, 1, activation='relu',
        ...
        out_a = Conv2D(64, 3, activation='relu', name='conv3_2_3x3')(out_a)
        out_a = BatchNormalization(name='conv3_2_3x3_bn')(out_a)
        out_a = Conv2D(256, 1, name='conv3_2_1x1_increase')(out_a)
        ...
        out_a = Conv2D(64, 3, activation='relu', name='conv3_3_3x3')(out_a)
        out_a = BatchNormalization(name='conv3_3_3x3_bn')(out_a)
        out_a = Conv2D(256, 1, name='conv3_3_1x1_increase')(out_a)
        ...
        out_a = Conv2D(64, 3, activation='relu', name='conv3_4_3x3')(out_a)
        out_a = BatchNormalization(name='conv3_4_3x3_bn')(out_a)
        out_a = Conv2D(256, 1, name='conv3_4_1x1_increase')(out_a)
        ...
        out_a = Conv2D(512, 1, name='conv4_1_1x1_proj')(out_b)
        out_a = BatchNormalization(name='conv4_1_1x1_proj_bn')(out_a)
        out_b = Conv2D(128, 1, activation='relu',
        ...
        out_b = Conv2D(128, 3, dilation_rate=2, activation='relu',
                       name='conv4_1_3x3')(out_b)
        out_b = BatchNormalization(name='conv4_1_3x3_bn')(out_b)
        out_b = Conv2D(512, 1, name='conv4_1_1x1_increase')(out_b)
        ...
        out_a = Conv2D(128, 1, activation='relu',
        ...
        out_a = Conv2D(128, 3, dilation_rate=2, activation='relu',
                       name='conv4_2_3x3')(out_a)
        out_a = BatchNormalization(name='conv4_2_3x3_bn')(out_a)
        out_a = Conv2D(512, 1, name='conv4_2_1x1_increase')(out_a)
        ...
        out_a = Conv2D(512, 1, name='conv4_3_1x1_increase')(out_a)
        ...
        out_a = Conv2D(512, 1, name='conv4_4_1x1_increase')(out_a)
        ...
        out_a = Conv2D(512, 1, name='conv4_5_1x1_increase')(out_a)
        ...
        out_a = Conv2D(512, 1, name='conv4_6_1x1_increase')(out_a)
        ...
        out_b = Conv2D(1024, 1, name='conv5_1_1x1_proj')(out_a)
        out_b = BatchNormalization(name='conv5_1_1x1_proj_bn')(out_b)
        out_a = Conv2D(256, 1, activation='relu',
        ...
        out_a = Conv2D(256, 3, dilation_rate=4, activation='relu',
                       name='conv5_1_3x3')(out_a)
        out_a = BatchNormalization(name='conv5_1_3x3_bn')(out_a)
        out_a = Conv2D(1024, 1, name='conv5_1_1x1_increase')(out_a)
        ...
        out_a = Conv2D(1024, 1, name='conv5_2_1x1_increase')(out_a)
        ...
        out_a = Conv2D(1024, 1, name='conv5_3_1x1_increase')(out_a)
        ...
        out_a = Conv2D(256, 1, activation='relu', name='conv5_4_k1')(out_a)
        ...
        out_a = Conv2D(128, 3, dilation_rate=2, name='conv_sub4')(out_a)
        out_a = BatchNormalization(name='conv_sub4_bn')(out_a)
        out_b = Conv2D(128, 1, name='conv3_1_sub2_proj')(out_c)
        ...
        out_b = Conv2D(128, 3, dilation_rate=2, name='conv_sub2')(out_a)
        ...
        out_a = Conv2D(64, 3, strides=2, padding='same', activation='relu',
                       name='conv3_sub1')(out_a)
        out_a = BatchNormalization(name='conv3_sub1_bn')(out_a)
        out_a = Conv2D(128, 1, name='conv3_sub1_proj')(out_a)
