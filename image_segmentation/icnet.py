...
class ICNetModelFactory(object):
    ...
    def build(img_size, n_classes, alpha=1.0, weights_path=None, train=False):
        ...
        out_a = Conv2D(int(alpha * 32), 3, strides=2, padding='same', activation='relu', use_bias=False, name='conv1_1_3x3_s2')(out_a)
        out_a = BatchNormalization(name='conv1_1_3x3_s2_bn')(out_a)
        out_a = Conv2D(int(alpha * 32), 3, padding='same', activation='relu', use_bias=False, name='conv1_2_3x3')(out_a)
        out_a = BatchNormalization(name='conv1_2_3x3_s2_bn')(out_a)
        out_a = Conv2D(int(alpha * 64), 3, padding='same', activation='relu', use_bias=False, name='conv1_3_3x3')(out_a)
        out_a = BatchNormalization(name='conv1_3_3x3_bn')(out_a)
        out_b = MaxPooling2D(pool_size=3, strides=2, name='pool1_3x3_s2')(out_a)

        out_a = Conv2D(int(alpha * 128), 1, use_bias=False, name='conv2_1_1x1_proj')(out_b)
        out_a = BatchNormalization(name='conv2_1_1x1_proj_bn')(out_a)
        out_b = Conv2D(int(alpha * 32), 1, use_bias=False, activation='relu', name='conv2_1_1x1_reduce')(out_b)
        out_b = BatchNormalization(name='conv2_1_1x1_reduce_bn')(out_b)
        out_b = ZeroPadding2D(name='padding1')(out_b)
        out_b = Conv2D(int(alpha * 32), 3, activation='relu', use_bias=False, name='conv2_1_3x3')(out_b)
        out_b = BatchNormalization(name='conv2_1_3x3_bn')(out_b)
        out_b = Conv2D(int(alpha * 128), 1, use_bias=False, name='conv2_1_1x1_increase')(out_b)
        ...
        out_a = Conv2D(int(alpha * 32), 1, activation='relu', use_bias=False, name='conv2_2_1x1_reduce')(out_b)
        out_a = BatchNormalization(name='conv2_2_1x1_reduce_bn')(out_a)
        out_a = ZeroPadding2D(name='padding2')(out_a)
        out_a = Conv2D(int(alpha * 32), 3, use_bias=False, activation='relu', name='conv2_2_3x3')(out_a)
        out_a = BatchNormalization(name='conv2_2_3x3_bn')(out_a)
        out_a = Conv2D(int(alpha * 128), 1, use_bias=False, name='conv2_2_1x1_increase')(out_a)
        ...
        out_a = Conv2D(int(alpha * 32), 1, activation='relu', use_bias=False, name='conv2_3_1x1_reduce')(out_b)
        out_a = BatchNormalization(name='conv2_3_1x1_reduce_bn')(out_a)
        out_a = ZeroPadding2D(name='padding3')(out_a)
        out_a = Conv2D(int(alpha * 32), 3, activation='relu', use_bias=False, name='conv2_3_3x3')(out_a)
        out_a = BatchNormalization(name='conv2_3_3x3_bn')(out_a)
        out_a = Conv2D(int(alpha * 128), 1, use_bias=False, name='conv2_3_1x1_increase')(out_a)
        ...
        out_a = Conv2D(int(alpha * 256), 1, strides=2, use_bias=False, name='conv3_1_1x1_proj')(out_b)
        out_a = BatchNormalization(name='conv3_1_1x1_proj_bn')(out_a)
        out_b = Conv2D(int(alpha * 64), 1, strides=2, activation='relu', use_bias=False, name='conv3_1_1x1_reduce')(out_b)
        out_b = BatchNormalization(name='conv3_1_1x1_reduce_bn')(out_b)
        out_b = ZeroPadding2D(name='padding4')(out_b)
        out_b = Conv2D(int(alpha * 64), 3, activation='relu', use_bias=False, name='conv3_1_3x3')(out_b)
        out_b = BatchNormalization(name='conv3_1_3x3_bn')(out_b)
        out_b = Conv2D(int(alpha * 256), 1, use_bias=False, name='conv3_1_1x1_increase')(out_b)
        ...
        out_a = Conv2D(int(alpha * 64), 1, activation='relu', use_bias=False, name='conv3_2_1x1_reduce')(out_b)
        out_a = BatchNormalization(name='conv3_2_1x1_reduce_bn')(out_a)
        out_a = ZeroPadding2D(name='padding5')(out_a)
        out_a = Conv2D(int(alpha * 64), 3, activation='relu', use_bias=False, name='conv3_2_3x3')(out_a)
        out_a = BatchNormalization(name='conv3_2_3x3_bn')(out_a)
        out_a = Conv2D(int(alpha * 256), 1, use_bias=False, name='conv3_2_1x1_increase')(out_a)
        ...
        out_a = Conv2D(int(alpha * 64), 1, activation='relu', use_bias=False, name='conv3_3_1x1_reduce')(out_b)
        out_a = BatchNormalization(name='conv3_3_1x1_reduce_bn')(out_a)
        out_a = ZeroPadding2D(name='padding6')(out_a)
        out_a = Conv2D(int(alpha * 64), 3, activation='relu', use_bias=False, name='conv3_3_3x3')(out_a)
        out_a = BatchNormalization(name='conv3_3_3x3_bn')(out_a)
        out_a = Conv2D(int(alpha * 256), 1, use_bias=False, name='conv3_3_1x1_increase')(out_a)
        ...
        out_a = Conv2D(int(alpha * 64), 1, activation='relu', use_bias=False, name='conv3_4_1x1_reduce')(out_b)
        out_a = BatchNormalization(name='conv3_4_1x1_reduce_bn')(out_a)
        out_a = ZeroPadding2D(name='padding7')(out_a)
        out_a = Conv2D(int(alpha * 64), 3, activation='relu', use_bias=False, name='conv3_4_3x3')(out_a)
        out_a = BatchNormalization(name='conv3_4_3x3_bn')(out_a)
        out_a = Conv2D(int(alpha * 256), 1, use_bias=False, name='conv3_4_1x1_increase')(out_a)
        ...
        out_a = Conv2D(int(alpha * 512), 1, use_bias=False, name='conv4_1_1x1_proj')(out_b)
        out_a = BatchNormalization(name='conv4_1_1x1_proj_bn')(out_a)
        out_b = Conv2D(int(alpha * 128), 1, activation='relu', use_bias=False, name='conv4_1_1x1_reduce')(out_b)
        out_b = BatchNormalization(name='conv4_1_1x1_reduce_bn')(out_b)
        out_b = ZeroPadding2D(padding=2, name='padding8')(out_b)
        out_b = Conv2D(int(alpha * 128), 3, dilation_rate=2, activation='relu', use_bias=False, name='conv4_1_3x3')(out_b)
        out_b = BatchNormalization(name='conv4_1_3x3_bn')(out_b)
        out_b = Conv2D(int(alpha * 512), 1, use_bias=False, name='conv4_1_1x1_increase')(out_b)
        ...
        out_a = Conv2D(int(alpha * 128), 1, activation='relu', use_bias=False, name='conv4_2_1x1_reduce')(out_b)
        out_a = BatchNormalization(name='conv4_2_1x1_reduce_bn')(out_a)
        out_a = ZeroPadding2D(padding=2, name='padding9')(out_a)
        out_a = Conv2D(int(alpha * 128), 3, dilation_rate=2, activation='relu', use_bias=False, name='conv4_2_3x3')(out_a)
        out_a = BatchNormalization(name='conv4_2_3x3_bn')(out_a)
        out_a = Conv2D(int(alpha * 512), 1, use_bias=False, name='conv4_2_1x1_increase')(out_a)
        ...
        out_a = Conv2D(int(alpha * 128), 1, activation='relu', use_bias=False, name='conv4_3_1x1_reduce')(out_b)
        out_a = BatchNormalization(name='conv4_3_1x1_reduce_bn')(out_a)
        out_a = ZeroPadding2D(padding=2, name='padding10')(out_a)
        out_a = Conv2D(int(alpha * 128), 3, dilation_rate=2, activation='relu', use_bias=False, name='conv4_3_3x3')(out_a)
        out_a = BatchNormalization(name='conv4_3_3x3_bn')(out_a)
        out_a = Conv2D(int(alpha * 512), 1, use_bias=False, name='conv4_3_1x1_increase')(out_a)
        ...
        out_a = Conv2D(int(alpha * 128), 1, activation='relu', use_bias=False, name='conv4_4_1x1_reduce')(out_b)
        out_a = BatchNormalization(name='conv4_4_1x1_reduce_bn')(out_a)
        out_a = ZeroPadding2D(padding=2, name='padding11')(out_a)
        out_a = Conv2D(int(alpha * 128), 3, dilation_rate=2, activation='relu', use_bias=False, name='conv4_4_3x3')(out_a)
        out_a = BatchNormalization(name='conv4_4_3x3_bn')(out_a)
        out_a = Conv2D(int(alpha * 512), 1, use_bias=False, name='conv4_4_1x1_increase')(out_a)
        ...
        out_a = Conv2D(int(alpha * 128), 1, activation='relu', use_bias=False, name='conv4_5_1x1_reduce')(out_b)
        out_a = BatchNormalization(name='conv4_5_1x1_reduce_bn')(out_a)
        out_a = ZeroPadding2D(padding=2, name='padding12')(out_a)
        out_a = Conv2D(int(alpha * 128), 3, dilation_rate=2, activation='relu', use_bias=False, name='conv4_5_3x3')(out_a)
        out_a = BatchNormalization(name='conv4_5_3x3_bn')(out_a)
        out_a = Conv2D(int(alpha * 512), 1, use_bias=False, name='conv4_5_1x1_increase')(out_a)
        ...
        out_a = Conv2D(int(alpha * 128), 1, activation='relu', use_bias=False, name='conv4_6_1x1_reduce')(out_b)
        out_a = BatchNormalization(name='conv4_6_1x1_reduce_bn')(out_a)
        out_a = ZeroPadding2D(padding=2, name='padding13')(out_a)
        out_a = Conv2D(int(alpha * 128), 3, dilation_rate=2, activation='relu', use_bias=False, name='conv4_6_3x3')(out_a)
        out_a = BatchNormalization(name='conv4_6_3x3_bn')(out_a)
        out_a = Conv2D(int(alpha * 512), 1, use_bias=False, name='conv4_6_1x1_increase')(out_a)
        ...
        out_b = Conv2D(int(alpha * 1024), 1, use_bias=False, name='conv5_1_1x1_proj')(out_a)
        out_b = BatchNormalization(name='conv5_1_1x1_proj_bn')(out_b)
        out_a = Conv2D(int(alpha * 256), 1, activation='relu', use_bias=False, name='conv5_1_1x1_reduce')(out_a)
        out_a = BatchNormalization(name='conv5_1_1x1_reduce_bn')(out_a)
        out_a = ZeroPadding2D(padding=4, name='padding14')(out_a)
        out_a = Conv2D(int(alpha * 256), 3, dilation_rate=4, activation='relu', use_bias=False, name='conv5_1_3x3')(out_a)
        out_a = BatchNormalization(name='conv5_1_3x3_bn')(out_a)
        out_a = Conv2D(int(alpha * 1024), 1, use_bias=False, name='conv5_1_1x1_increase')(out_a)
        ...
        out_a = Conv2D(int(alpha * 256), 1, activation='relu', use_bias=False, name='conv5_2_1x1_reduce')(out_b)
        out_a = BatchNormalization(name='conv5_2_1x1_reduce_bn')(out_a)
        out_a = ZeroPadding2D(padding=4, name='padding15')(out_a)
        out_a = Conv2D(int(alpha * 256), 3, dilation_rate=4, activation='relu', use_bias=False, name='conv5_2_3x3')(out_a)
        out_a = BatchNormalization(name='conv5_2_3x3_bn')(out_a)
        out_a = Conv2D(int(alpha * 1024), 1, use_bias=False, name='conv5_2_1x1_increase')(out_a)
        ...
        out_a = Conv2D(int(alpha * 256), 1, activation='relu', use_bias=False, name='conv5_3_1x1_reduce')(out_b)
        out_a = BatchNormalization(name='conv5_3_1x1_reduce_bn')(out_a)
        out_a = ZeroPadding2D(padding=4, name='padding16')(out_a)
        out_a = Conv2D(int(alpha * 256), 3, dilation_rate=4, activation='relu', use_bias=False, name='conv5_3_3x3')(out_a)
        out_a = BatchNormalization(name='conv5_3_3x3_bn')(out_a)
        out_a = Conv2D(int(alpha * 1024), 1, use_bias=False, name='conv5_3_1x1_increase')(out_a)
        ...
        pool1 = AveragePooling2D(pool_size=pool_height,strides=pool_height, name='conv5_3_pool1')(out_a)
        pool1 = UpSampling2D(size=12 * pool_scale, name='conv5_3_pool1_interp')(pool1)
        pool2 = AveragePooling2D(pool_size=pool_height // 2, strides=pool_height // 2, name='conv5_3_pool2')(out_a)
        pool2 = UpSampling2D(size=6 * pool_scale, name='conv5_3_pool2_interp')(pool2)
        pool3 = AveragePooling2D(pool_size=pool_height // 3, strides=pool_height // 3, name='conv5_3_pool3')(out_a)
        pool3 = UpSampling2D(size=4 * pool_scale, name='conv5_3_pool3_interp')(pool3)
        pool4 = AveragePooling2D(pool_size=pool_height // 4, strides=pool_height // 4, name='conv5_3_pool4')(out_a)
        pool4 = UpSampling2D(size=3 * pool_scale, name='conv5_3_pool6_interp')(pool4)

        out_a = Add(name='conv5_3_sum')([out_a, pool1, pool2, pool3, pool4])
        out_a = Conv2D(int(alpha * 256), 1, activation='relu', use_bias=False, name='conv5_4_k1')(out_a)
        ...
        out_a = Conv2D(int(alpha * 128), 3, dilation_rate=2, use_bias=False, name='conv_sub4')(out_a)
        out_a = BatchNormalization(name='conv_sub4_bn')(out_a)
        out_b = Conv2D(int(alpha * 128), 1, use_bias=False, name='conv3_1_sub2_proj')(out_c)
        ...
        out_b = Conv2D(int(alpha * 128), 3, dilation_rate=2, use_bias=False, name='conv_sub2')(out_a)
        out_b = BatchNormalization(name='conv_sub2_bn')(out_b)

        # The full scale branch
        out_a = Conv2D(int(alpha * 32), 3, strides=2, padding='same', activation='relu', use_bias=False, name='conv1_sub1')(inpt)
        out_a = BatchNormalization(name='conv1_sub1_bn')(out_a)
        out_a = Conv2D(int(alpha * 32), 3, strides=2, padding='same', activation='relu', use_bias=False, name='conv2_sub1')(out_a)
        out_a = BatchNormalization(name='conv2_sub1_bn')(out_a)
        out_a = Conv2D(int(alpha * 64), 3, strides=2, padding='same', activation='relu', use_bias=False, name='conv3_sub1')(out_a)
        out_a = BatchNormalization(name='conv3_sub1_bn')(out_a)
        out_a = Conv2D(int(alpha * 128), 1, use_bias=False, name='conv3_sub1_proj')(out_a)
        ...
        out = Conv2D(n_classes, 1, activation='softmax', name='conv6_cls')(out_a)
